# validacao-cluster-local Specification

## Purpose
Cluster Kubernetes local para exercitar o manifesto de deploy, e o conjunto de verificações ativas que provam o deploy contra as falhas silenciosas conhecidas.
