# imagem-multiplataforma Specification

## Purpose
Construção e publicação da imagem da aplicação para múltiplas arquiteturas sob uma referência de versão imutável, em registro público.
